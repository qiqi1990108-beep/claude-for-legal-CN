...
1. 加载 `~/.claude/plugins/config/claude-for-legal/employment-legal-cn/CLAUDE.md` → 管辖范围、规章制度位置。
2. 使用以下工作流。
...
`~/.claude/plugins/config/claude-for-legal/employment-legal-cn/CLAUDE.md` → 管辖范围、规章制度位置和格式。
