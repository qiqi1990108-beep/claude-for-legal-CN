...
`~/.claude/plugins/config/claude-for-legal/employment-legal-cn/CLAUDE.md` → 规章制度位置、省级补充条款列表、更新频率。
...
对于 `~/.claude/plugins/config/claude-for-legal/employment-legal-cn/CLAUDE.md` 中的每个省/直辖市补充条款：
